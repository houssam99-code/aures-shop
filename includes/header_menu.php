...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">AURES SHOP</a>
                    ...
                    <ul class="nav navbar-nav">
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
							   ...
							   while($row=mysqli_fetch_array($query)) {
								   $catname=$row["name"];
									echo "<a href='products.php?cat=$catname' class='dropdown-item'>$catname</a>";
							   }
									?>
                               </div>
					   ...
					   <?php 
							   ...
							   while($row2=mysqli_fetch_array($query)) {
								   $adminemail=$row2["adminemail"];
							   }
						 if (isset($_SESSION['email']) and ($_SESSION['email']==$adminemail)){?>
						   <li class="nav-item"><a href="manage.php" class="nav-link">Manage products</a></li>
						   <li class="nav-item"><a href="commands.php" class="nav-link">Manage Commands</a></li>
						   <?php
					   }
					   ?>
